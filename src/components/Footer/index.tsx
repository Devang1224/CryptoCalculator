           ...
           <div className="flex flex-col gap-[16px] h-min">
            ...
            <div className="flex flex-col gap-[16px]">
                ...
                <ul className="text-[14px] leading-[20px] flex flex-col gap-[12px] text-[#FFFFFFA6] md:gap-[19px] md:text-white md:text-[15px] md:leading-[17px]">
                    ...
                    <li className="flex gap-[11.94px] items-center">Careers<span className="leading-[13px] font-semibold rounded-[2px] text-[11px] pt-[3px] pl-[8px] pr-[9.97px]  pb-[4.19px] bg-[#2997F980] text-white">{"We're hiring"}</span></li>
                    <li>Security</li>
                    <li>Refund Policy</li>
                    <li>Brand Assets</li>
                    <li>Terms of use</li>
